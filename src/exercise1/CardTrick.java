...
public class CardTrick {
    ...
    /*private static void printInfo() {
        ...
        System.out.println("My name is Navjot Kaur, but you can call me Navjot");
        System.out.println();
        
        System.out.println("My career ambitions:");
        System.out.println("-- I want to become a successful programmer.");
        System.out.println("-- I also want to learn more programming languages.");
	System.out.println();	

        System.out.println("My hobbies:");
        System.out.println("-- exploring nature.");
        System.out.println("-- Spend time with my family.");
